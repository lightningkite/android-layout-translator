#
# Be sure to run `pod lib lint XmlToXibRuntime.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XmlToXibRuntime.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'XmlToXibRuntime/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XmlToXibRuntime' => ['XmlToXibRuntime/Assets/*.png']
  # }
